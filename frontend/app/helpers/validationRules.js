...
Object.assign(Validation.rules, {
  ...
  required: {
    ...
    hint: value => {
      return <span className={fs.formErrorIsVisible}>{'This field is required.'}</span>
    },
  },
  email: {
    // Example usage with external 'validator'
    rule: (value, components) => {
      return validator.isEmail(value, {require_tld: false})
    },
    hint: (value, components) => {
      return <span className={fs.formErrorIsVisible}>{value + ' isnt an Email.'}</span>
    },
  },
  number: {
    // Example usage with external 'validator'
    ...
    hint: (value, components) => {
      return <span className={fs.formErrorIsVisible}>{value + ' isnt a number.'}</span>
    },
  },
  ...
  password: {
    ...
    hint: () => <span className={fs.formErrorIsVisible}>{'Passwords should be equal.'}</span>,
  },
